  ...
  return (
    <>
      <div style={{ position: "absolute", left: '30px', bottom: '60px', backgroundColor: 'rgba(255, 255, 255, 0.7)', borderRadius: '10px', padding: '20px', minWidth: '300px', color: '#000000' }}>
        <h5>Select line</h5>
        <select value={selectedLineCode} onChange={(e) => { setSelectedLineCode(e.target.value); if (e.target.value !== '') { setLoadingRoutes(true); getRoutesForLine(e.target.value); } }} style={{ width: "250px" }}>
